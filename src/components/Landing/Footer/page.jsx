    ...
    <div className="w-full md:h-[312px]  bg-emerald-500">
      <div className="w-full h-[111px]  mx-auto py-5 ">
        ...
        <div className="flex items-center justify-between w-[231px] h-4 mx-auto font-nunito">
          <ScrollLink to="home" smooth={true} duration={500} className="text-white text-nunito text-[12px]">
            Home
          </ScrollLink>
          <ScrollLink to="features" smooth={true} duration={500} className="text-white text-nunito text-[12px]">
            Features
          </ScrollLink>
          <ScrollLink to="about" smooth={true} duration={500} className="text-white text-nunito text-[12px]">
              About us
          </ScrollLink>
          <ScrollLink to="faq" smooth={true} duration={500} className="text-white text-nunito text-[12px]">
              FAQ
          </ScrollLink>
        </div>
      </div>
