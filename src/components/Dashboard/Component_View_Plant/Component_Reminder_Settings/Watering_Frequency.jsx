...
export default function Watering_Frequency({ dataPlants }) {
  const wateringFrequency =
    dataPlants?.watering_schedule.watering_frequency || 0;
  const each = dataPlants?.watering_schedule.each || "";
  const wateringTime = dataPlants?.watering_schedule.watering_time || "N/A";
  const wateringAmount = dataPlants?.watering_schedule.watering_amount || 0;
  const unit = dataPlants?.watering_schedule.unit || "";
